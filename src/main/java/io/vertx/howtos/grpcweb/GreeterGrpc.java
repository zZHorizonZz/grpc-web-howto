...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.vertx.howtos.grpcweb.HelloRequest,
      io.vertx.howtos.grpcweb.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = io.vertx.howtos.grpcweb.HelloRequest.class,
      responseType = io.vertx.howtos.grpcweb.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.vertx.howtos.grpcweb.HelloRequest,
      io.vertx.howtos.grpcweb.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<io.vertx.howtos.grpcweb.HelloRequest, io.vertx.howtos.grpcweb.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<io.vertx.howtos.grpcweb.HelloRequest, io.vertx.howtos.grpcweb.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.vertx.howtos.grpcweb.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.vertx.howtos.grpcweb.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    default void sayHello(io.vertx.howtos.grpcweb.HelloRequest request,
        io.grpc.stub.StreamObserver<io.vertx.howtos.grpcweb.HelloReply> responseObserver) {
  ...
  public static final class GreeterFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<io.vertx.howtos.grpcweb.HelloReply> sayHello(
        io.vertx.howtos.grpcweb.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((io.vertx.howtos.grpcweb.HelloRequest) request,
              (io.grpc.stub.StreamObserver<io.vertx.howtos.grpcweb.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              io.vertx.howtos.grpcweb.HelloRequest,
              io.vertx.howtos.grpcweb.HelloReply>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.vertx.howtos.grpcweb.HelloWorldProto.getDescriptor();
    }
