 ...
 * </ul>
 */
public class VertxGreeterGrpcService extends VertxGreeterService implements Service {
   ...
   */
  public static Service of(VertxGreeterService service) {
  ...
  public static final ServiceMethod<io.vertx.howtos.grpcweb.HelloRequest, io.vertx.howtos.grpcweb.HelloReply> SayHello = ServiceMethod.server(
    ...
    GrpcMessageDecoder.decoder(io.vertx.howtos.grpcweb.HelloRequest.newBuilder()));
   ...
   */
  public static Builder builder(VertxGreeterService service) {
  ...
  public static class Builder implements ServiceBuilder {
    ...
    private final VertxGreeterService instance;

    private Builder(VertxGreeterService instance) {
...
//    }
    ...
    private class Invoker implements Service {
      ...
      private <Req, Resp> Handler<io.vertx.grpc.server.GrpcServerRequest<Req, Resp>> resolveHandler(ServiceMethod<Req, Resp> serviceMethod) {
        if (SayHello == serviceMethod) {
          Handler<io.vertx.grpc.server.GrpcServerRequest<io.vertx.howtos.grpcweb.HelloRequest, io.vertx.howtos.grpcweb.HelloReply>> handler = this::handle_sayHello;
  ...
  private void handle_sayHello(io.vertx.grpc.server.GrpcServerRequest<io.vertx.howtos.grpcweb.HelloRequest, io.vertx.howtos.grpcweb.HelloReply> request) {
    request.handler(msg -> {
      try {
